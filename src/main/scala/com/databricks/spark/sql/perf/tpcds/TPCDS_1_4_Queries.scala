...
trait Tpcds_1_4_Queries extends Benchmark {
  ...
  val tpcds1_4Queries = Seq(
    ...
    ("q19_baidu_tuned_2", """
        ...
        |   and d_year = 1999
        |   and i_manager_id between 7 and 8
        |   and substr(ca_zip, 1, 5) <> substr(s_zip, 1, 5)
        | group by
        |   i_brand,
        |   i_brand_id,
    ...
    ("q42_baidu_tuned", """
        ...
        |  -- and dt.d_moy = 12
        |  -- and dt.d_year = 1998
        |  -- and ss_date between '1998-01-01' and '2000-12-31'
        |  and ss_sold_date_sk between 2450815 and 2451910  -- partition key filter
        | group by
        |  d_year,
        |  i_category_id,
        |  i_category
    ...
    ("q42_baidu_tuned_2", """
        ...
        |  join date_dim dt on (dt.d_date_sk = store_sales.ss_sold_date_sk)
        | where
        |  item.i_manager_id between 1 and 2
        |  -- and dt.d_moy = 12
        |  -- and dt.d_year = 1998
    ...
    ("q43_baidu_tuned", """
        ...
        |  -- and ss_date between '1998-01-01' and '1999-12-31'
        |  and ss_sold_date_sk between 2450816 and 2451544  -- partition key filter
        | group by
        |  s_store_name,
        |  s_store_id
        | order by
    ...
    ("q55_baidu", """
        ...
        |  and d_moy between 1 and 12
        |  and d_year = 2001
        |  -- and ss_date between '2001-01-01' and '2001-12-31'
        ...
        |  -- and ss_date between '2000-01-01' and '2001-12-31'
        |  and ss_sold_date_sk between 2451545 and 2452275 -- partition key filter
        | group by
        |  i_brand,
        |  i_brand_id
        | order by
        ...
        |    join date_dim on (store_sales.ss_sold_date_sk = date_dim.d_date_sk)
        |  where
        |    ss_sold_date_sk between 2451545 and 2452275  -- partition key filter
        |    -- ss_date between '2000-01-01' and '2001-12-31'
        |    and d_month_seq in (1212, 1212 + 1, 1212 + 2, 1212 + 3, 1212 + 4, 1212 + 5, 1212 + 6, 1212 + 7, 1212 + 8, 1212 + 9, 1212 + 10, 1212 + 11)
        |    and (
        |          (i_category in('Books', 'Children', 'Electronics')
        |            and i_class in('personal', 'portable', 'refernece', 'self-help')
        ...
        |        and (household_demographics.hd_dep_count = 5
        |      or household_demographics.hd_vehicle_count = 3)
        |    and d_date between '1999-01-01' and '1999-12-31'
        |    and ss_sold_date_sk between 2451180 and 2451544 -- partition key filter (12 months)
        |  group by
        |    ss_ticket_number,
        |    ss_customer_sk,
        |    ss_addr_sk,
        ...
        |    and household_demographics.hd_vehicle_count > 0
        |    and case when household_demographics.hd_vehicle_count > 0 then household_demographics.hd_dep_count / household_demographics.hd_vehicle_count else null end > 1
        |    and ss_sold_date_sk between 2451180 and 2452275 -- partition key filter (36 months)
        |  group by
        |    ss_ticket_number,
        |    ss_customer_sk
        |  ) dj
        ...
        |  -- and ss_date between '2001-01-12' and '2001-02-11'
        |  -- and ss_sold_date_sk between 2451922 and 2451952  -- partition key filter
        |  and ss_sold_date_sk between 2451911 and 2452091  -- partition key filter (6 calendar months)
        |  and d_date between '2001-01-01' and '2001-06-30'
        | group by
        |  i_item_id,
        |  i_item_desc,
        |  i_category,
